...
set "status-style" "none,fg=$onedark_white,bg=$onedark_black"

setw "window-status-style" "none,fg=$onedark_black,bg=$onedark_black"
setw "window-status-activity-style" "none,fg=$onedark_black,bg=$onedark_black"
